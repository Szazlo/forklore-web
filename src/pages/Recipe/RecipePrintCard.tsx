...
export default function RecipePrintCard(props: RecipeData) {
	return (
		<Container className="bg-gray-200 p-4 my-10">
				...
				<div>
					...
					<div className="flex items-center gap-2 my-2">
						...
						<Typography color="text.dark">
							{props.averageRating} / 10 reviews
						</Typography>
					</div>
				</div>
				<div className="ml-4">
					...
					>
						<div className="w-8">
							<Box
								...
								className="w-6 h-6 flex align-middle justify-center rounded text-white"
							>
								{step.stepNumber}
							</Box>
						</div>
			...
			<List>
				<ListItem>
					Ensure the freshness of your mixed greens. Look for crisp, vibrant eaves
					with no signs of wilting or browning
				</ListItem>
			</List>
		</Container>
	);
...
function ListItem({ children }: any) {
	return (
		<div className="flex">
			<Box
				className="rounded-xl w-3 h-2 m-2"
				bgcolor="primary.main"
			/>
			{children}
		</div>
